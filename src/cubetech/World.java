...
//
//                if(node.Axis == 0) {
//                    if(block.getPosition().x > node.Dist)
//                        node = node.children[0];
//                    else if(block.getPosition().x + block.getSize().x < node.Dist)
//                        node = node.children[1];
//                    else
//                        break;
//
//                } else {
//                    if(block.getPosition().y > node.Dist)
//                        node = node.children[0];
//                    else if(block.getPosition().y + block.getSize().y < node.Dist)
//                        node = node.children[1];
//                    else
//                        break;
//                }
