...
//        volumeBar = Ref.ResMan.LoadTexture("data/healthbar.png");
...
//        spr.Set(0.5f, 0.5f, 0.37f);
//        spr.SetColor(0, 0, 0, 90);
//    }
//
//    public void Exit() {
//        if(bgmusic != null) {
...
////            return;
//        lastscoretime = Ref.client.realtime;
//        //{
//
...
//        Ref.textMan.AddText(new Vector2f(0.5f,0.8f), "Scoreboard", Align.CENTER, Type.HUD);
//
//        for (int i = 0; i < 10; i++) {
//            Ref.textMan.AddText(new Vector2f(0.2f, 0.7f - 0.05f*i), ""+(i+1), Align.CENTER, Type.HUD);
//            Ref.textMan.AddText(new Vector2f(0.3f, 0.7f - 0.05f*i), scoreNames[i], Align.LEFT, Type.HUD);
//            Ref.textMan.AddText(new Vector2f(0.8f, 0.7f - 0.05f*i), scoreScores[i], Align.RIGHT, Type.HUD);
//        }
//
//        // Exit button
...
//        Vector2f mousePos = Ref.Input.playerInput.MousePos;
//
//        Ref.textMan.AddText(new Vector2f(0.5f,0.8f), "Options", Align.CENTER, Type.HUD);
//
//        // Music volume
//        Ref.textMan.AddText(new Vector2f(0.5f,0.72f), "Music Volume", Align.RIGHT, Type.HUD);
//        Sprite spr = Ref.SpriteMan.GetSprite(Type.HUD);
...
//
//        // Effect volume
//        Ref.textMan.AddText(new Vector2f(0.5f,0.66f), "Effect Volume", Align.RIGHT, Type.HUD);
//        spr = Ref.SpriteMan.GetSprite(Type.HUD);
...
//        Sprite spr = Ref.SpriteMan.GetSprite(Type.HUD);
//        spr.Set(0.5f, 0.5f, 0.5f, background);
...
//
//        spr = Ref.SpriteMan.GetSprite(Type.HUD);
//        spr.Set(Ref.Input.playerInput.MousePos.x, Ref.Input.playerInput.MousePos.y, 0.09f);
//    }
//
