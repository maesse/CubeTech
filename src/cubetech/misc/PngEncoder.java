...
public class PngEncoder extends Object {
     ...
     * @see java.awt.Image
     */
    public PngEncoder(ByteBuffer image, int width, int height) {
        this(image, false, FILTER_NONE, 0,  width,  height);
    }
     ...
     * @see java.awt.Image
     */
    public PngEncoder(ByteBuffer image, boolean encodeAlpha, int width, int height) {
        this(image, encodeAlpha, FILTER_NONE, 0,  width,  height);
    }
     ...
     * @see java.awt.Image
     */
    public PngEncoder(ByteBuffer image, boolean encodeAlpha, int whichFilter, int width, int height) {
        this(image, encodeAlpha, whichFilter, 0,  width,  height);
    }
     ...
     * @see java.awt.Image
     */
    public PngEncoder(ByteBuffer image, boolean encodeAlpha, int whichFilter, int compLevel, int width, int height) {
        this.width = width;
        this.height = height;
        this.image = image;
            ...
            while (rowsLeft > 0) {
                ...
                try {
                    ...
                    for (int i= 0; i < nRows; i++) {
                        int row = flipStartRow - i;
                        image.position(row * width * 3);

                        for (int j= 0; j < width; j++) {
                            pixels[i*width + j] = (127 << 24) |
                                ((image.get() & 0xff) << 16) |
                                ((image.get() & 0xff) << 8) |
                                ((image.get() & 0xff));
                        }
                    ...
                    System.err.println("Failed to read pixels from bytebuffer");
                    return false;
                }
