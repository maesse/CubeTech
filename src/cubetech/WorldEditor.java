...
//        this.world = world;
//
//        scaleTex = Ref.ResMan.LoadTexture("data/scale.png");
//
//        dims = Ref.ResMan.LoadTexture("data/dims.png");
//        toFront = Ref.ResMan.LoadTexture("data/tofront.png");
//        grid = Ref.ResMan.LoadTexture("data/grid.png");
//
//        open = Ref.ResMan.LoadTexture("data/open.png");
//        save = Ref.ResMan.LoadTexture("data/save.png");
//        newfile = Ref.ResMan.LoadTexture("data/new.png");
//
//        editTextures.add(Ref.ResMan.LoadTexture("data/tile.png"));
////        editTextures.add(Ref.ResMan.LoadResource("data/dims.png"));
////        editTextures.add(Ref.ResMan.LoadResource("data/horizont.png"));
////        editTextures.add(Ref.ResMan.LoadResource("data/grass.png"));
////        editTextures.add(Ref.ResMan.LoadResource("data/grass2.png"));
////        editTextures.add(Ref.ResMan.LoadResource("data/Tiles_grass_set.png"));
////        editTextures.add(Ref.ResMan.LoadResource("data/Tiles_snow_set.png"));
////        editTextures.add(Ref.ResMan.LoadResource("data/Tiles_lava_set.png"));
//
//        editTextures.add(Ref.ResMan.LoadTexture("data/Cave01.png"));
//        editTextures.add(Ref.ResMan.LoadTexture("data/Cave02.png"));
//        editTextures.add(Ref.ResMan.LoadTexture("data/Cave03.png"));
//        editTextures.add(Ref.ResMan.LoadTexture("data/Cave04.png"));
//
//        customTextures[0] = Ref.ResMan.LoadTexture("data/tile.png");
...
//
//            // Assemble textures
//            buf.Write(editTextures.size()+"\n");
//            for (int i= 0; i < editTextures.size(); i++) {
//                buf.Write(editTextures.get(i).name + "\n");
//            }
//
//
//
...
//
//
//        Ref.textMan.AddText(new Vector2f(0.5f, 0.9f), "Edit Mode", Align.CENTER, Type.HUD);
//    }
//
...
//        spr.Set(0.5f, 0.1f, 0.1f, editTextures.get(editTextureSelected));
//
...
//
//            spr = Ref.SpriteMan.GetSprite(SpriteManager.Type.HUD);
//            spr.Set(0.5f+i*0.1f+0.12f, 0.1f, 0.05f, editTextures.get(editTextureSelected+1+i));
//            spr.SetColor(255,255,255, (int)((0.3f + 0.7f * invIFrac)*255));
...
//            spr = Ref.SpriteMan.GetSprite(SpriteManager.Type.HUD);
//            spr.Set(0.5f-i*0.1f-0.12f, 0.1f, 0.05f, editTextures.get(editTextureSelected-1-i));
//            spr.SetColor(255,255,255, (int)((0.4f + 0.6f * invIFrac)*255));
...
//
//            spr = Ref.SpriteMan.GetSprite(SpriteManager.Type.GAME);
//            spr.Set(pos.x + size.x, pos.y, 1f, dims);
//
//            spr = Ref.SpriteMan.GetSprite(SpriteManager.Type.GAME);
//            spr.Set(pos.x + size.x, pos.y + size.y, 1f, dims);
//
//            spr = Ref.SpriteMan.GetSprite(SpriteManager.Type.GAME);
//            spr.Set(pos.x, pos.y + size.y, 1f, dims);
//    }
//
